...
router.post("/cargamasiva", async function (req, res, next) {
 ...
 console.log(muchosdep)
  
 // --------------------------------------------------------------------------------------- VERIFICAR SI SON VARIOS PUESTOS 
 // --------------------------------------------------------------------------------------- ESTOS YA DEBERIAN SER ANIDADOS
 // PARA CASOS DE VARIOS DEPARTAMENTOS -- ESTE DEBERIA DE SER ANIDADO EN CADA DEPARTAMENTO 
 var muchospuestos = false 
 try { 
     if (jsonData.departamentos.departamento[0].puestos.puesto[0].nombre == undefined) { 
         muchospuestos = false 
     } else { 
         muchospuestos = true 
     } 
 ...
 console.log(muchospuestos) 
  
 // PARA CASO DE UN SOLO DEPARTAMENTO -- ESTE SERIA UNICO POR EL DEPARTAMENTO 
 try { 
     if (jsonData.departamentos.departamento.puestos.puesto[0].nombre == undefined) { 
         muchospuestos = false 
     } else { 
         muchospuestos = true 
     } 
 ...
 // PARA CASOS DE VARIOS DEPARTAMENTOS - PARA CASOS DE VARIOS PUESTOS 
 var muchascategorias = false 
 try {
     if (jsonData.departamentos.departamento[0].puestos.puesto[0].categorias[0].categoria.nombre == undefined) { 
 ...
 // PARA CASOS DE VARIOS DEPARTAMENTOS - PARA CASOS DE UNICO PUESTO
 try { 
     if (jsonData.departamentos.departamento[0].puestos.puesto.categorias[0].categoria.nombre == undefined) { 
         muchascategorias = false 
     } else { 
         muchascategorias = true 
     } 
 ...
 // PARA CASOS DE UNICO DEPARTAMENTO - PARA CASOS DE UNICO PUESTO
 try {
     if (jsonData.departamentos.departamento.puestos.puesto.categorias[0].categoria.nombre == undefined) { 
         muchascategorias = false 
     } else {
         muchascategorias = true 
     }
 ...
 try {
     if (jsonData.departamentos.departamento[0].puestos.puesto[0].requisitos[0].requisito.nombre == undefined) { 
 ...
 // PARA CASOS DE VARIOS DEPARTAMENTOS - PARA CASOS DE UNICO PUESTO
 try { 
     if (jsonData.departamentos.departamento[0].puestos.puesto.crequisitos[0].requisito.nombre == undefined) { 
         muchosrequisitos = false 
     } else { 
         muchosrequisitos = true 
     } 
 ...
 // PARA CASOS DE UNICO DEPARTAMENTO - PARA CASOS DE UNICO PUESTO
 try {
     if (jsonData.departamentos.departamento.puestos.puesto.requisitos[0].requisito.nombre == undefined) { 
         muchosrequisitos = false 
     } else {
         muchosrequisitos = true 
     }
        ...
        for (let contPuesto = 0; contPuesto < arregloPuestos.length; contPuesto++) {
          ...
          if (muchosrequisitos) {
            ...
            for (let contReq = 0; contReq < arregloReq.length; contReq++) {
              ...
              let responseCategoria = await service.connect(
                `BEGIN INSERT INTO REQUISITO VALUES('${nombreReq}','${nombrePuesto}','${nombreDep}',null,'${tamanioReq}','${obligReq}'); COMMIT; END;`
              );
          ...
          for (let contReq = 0; contReq < arregloReq.length; contReq++) {
            ...
            if (muchosformatos) {
              ...
              for (let contFormat = 0; contFormat < arregloFromat.length; contFormat++) {
                ...
                // UPDATE REQUISITO SET Formato='pdf' WHERE Nombre='dosrequisito' AND Puesto='unopuesto' AND Departamento='uno';
                let responseFormat = await service.connect(
                  `BEGIN UPDATE REQUISITO SET Formato='${nombreFormat}' WHERE Nombre='${nombreReq}' AND Puesto='${nombrePuesto}' AND Departamento='${nombreDep}'; COMMIT; END;`
                );
                console.log(response)
              }
            }
