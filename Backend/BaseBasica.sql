...
(2797652900101,'william alejandro', 'borrayo alarcon', '4321', 'wiliamborryo@gmail.com', 'casa', '1234', 'pendiente', 'hoy', 'maniana',1,'reev1' ,'uno', 'unopuesto' );

UPDATE APLICANTE_EMPLEADO SET Estado='pendiente' WHERE DPI=787489379824
UPDATE APLICANTE_EMPLEADO SET Estado='pendiente' WHERE DPI=27976529001017
UPDATE APLICANTE_EMPLEADO SET Estado='pendiente' WHERE DPI=787489379824
...
SELECT * FROM MENSAJE WHERE Emisor='2797652900101' OR Receptor='2797652900101' ORDER BY Orden ASC;
